...
function detalles($fila){
      ...
      if ($fila["dia"]==1) {
            ...
            echo '<img src="http://machupicchu.company/img/'.$fila["imagen"].'.jpg" alt="" class="imagen-paquetes img-responsive" >';
            echo '<img src="http://machupicchu.company/img/'.$fila["imagen"].'1.jpg" alt="" class="imagen-paquetes img-responsive" >';
            //echo '</p>';   
      }
      else {
            //echo '<p align="center">';
